...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  ...
  properties
    ...
    ..add(DiagnosticsProperty('user', _this.user))..add(DiagnosticsProperty('token', _this.token));
}

@override
bool operator ==(Object other) {
  final _this = this as AuthState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthState&&(identical(other.user, _this.user) || other.user == _this.user)&&(identical(other.token, _this.token) || other.token == _this.token));
}
...
int get hashCode {
  final _this = this as AuthState;
  return Object.hash(runtimeType,_this.user,_this.token);
}

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  final _this = this as AuthState;
  return 'AuthState(user: ${_this.user}, token: ${_this.token})';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? user,  String? token)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? user,  String? token)  $default,) {final _that = this;
switch (_that) {
case _AuthState():
return $default(_that.user,_that.token);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? user,  String? token)?  $default,) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.user,_that.token);case _:
  return null;
